...
--   Example host_id XXXXX (real anonymized case from this dataset)
...
-- snapshots (Example host_id XXXXX lost superhost status June → September 2025)
...
--   Example listing_id YYYYYY (real anonymized case from this dataset)
--   June 2025:      name = "YYYYYYY Apt - 10% Off Summer"
--   September 2025: name = "YYYYYYY Apt - XXXXXX View"
...
SELECT 
    ...
    -- decision (Example host_id XXXXX lost Superhost status June → September 2025).
